...
namespace DailyMutualFundNAVMicroservice
{
    ...
    options.UseSqlServer(Configuration.GetConnectionString("MutualFundContext") ?? throw new InvalidOperationException("Connection string 'MutualFundContext' not found.")));
